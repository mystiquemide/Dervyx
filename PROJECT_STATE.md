...
- Work completed:
  ...
  - Added `.github/workflows/ci.yml` to run the engine and web typechecks, 55-test suite, production build, and high-severity dependency audit on every push and pull request.
...
- Files or assets changed: `README.md`, `.env.example`, `.github/workflows/ci.yml`, `docs/DEPLOYMENT.md`, `public/screenshots/landing.png`, `public/screenshots/investigate.png`, `app/layout.tsx`, `next.config.mjs`, `package.json`, `package-lock.json`, `tsconfig.json`, `.gitignore`, and `PROJECT_STATE.md`; the systemd unit is an external deployment file.
