...
export const metadata: Metadata = {
  ...
  description:
    "Base investigation agent that turns one token and a block window into a reproducible, hash-verifiable funding and volume anomaly certificate. It reports observed relationships, not accusations.",
  ...
  openGraph: {
    ...
    title: "Dervyx \u00b7 Base funding-anomaly certificates",
    description:
      "Base investigation agent that turns one token and a block window into a reproducible, hash-verifiable funding-anomaly certificate. Evidence, not accusations.",
  },
  twitter: {
